 ...
 * Version: Project 1
 * Description: This file contains the bean to be used by the application to 
 *              connect to the database and perform queries and data inserts.
 */
package beans;
...
/**
 * This bean provides a connection for use by other beans and jsp files
 *
 * @author Lara Aras
 */
